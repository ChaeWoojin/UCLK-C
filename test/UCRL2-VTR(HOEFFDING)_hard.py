...
from env.env import *
from algorithms.ucrl2_vtr_hoeffding_hard_gurobi import UCRL2_VTR_HOEFFDING
...
def run_experiment(run, seed, d, D, T, N, delta, epsilon, resultDir):
    ...
    agent = UCRL2_VTR_HOEFFDING(env, T=T, N=N, delta=delta, epsilon=epsilon)
    
    # Run the UCRL2_VTR_HOEFFDING
